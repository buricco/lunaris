/*
 * This was generated automatically using the original version which used
 * autotools.  For use in Lunaris, a normal makefile was needed instead.
 *
 * S. V. Nickolas, Aug. 28, 2020
 */
